...
(function ($) {
    ...
    function get_template_value(){
        if ( $('body').hasClass('gutenberg-editor-page') ) {
            return $('option[value="template-builder.php"]').parent().val();
        } else {
    ...
    {
        page_metabox_visibililty();

        if ( $('body').hasClass('gutenberg-editor-page') ) {
            $('option[value="template-builder.php"]').parent().bind('change', page_metabox_visibililty);
        } else {
